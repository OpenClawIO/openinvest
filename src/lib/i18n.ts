...
export const copy = {
  en: {
    ...
    companyPrefix: "南京",
    companyCore: "慧言能策",
    companySuffix: "科技有限公司",
    companyLegal: "Nanjing Huiyan Nengce Technology Co., Ltd.",
    companyLegalZh: "南京慧言能策科技有限公司",
    tagline: "Public account",
    nav: "Net asset value",
    vsCost: "vs cost",
    inspectHint: "Heaven is the jade circle. Earth is the gold square. Drag the key.",
  ...
  zh: {
    ...
    nav: "净资产",
    vsCost: "相对成本",
    inspectHint: "天圆地方：羊脂玉为圆，黄金为方。可拖动钥匙。",
    delayedClose: "延迟收盘",
    underCost: "低于成本",
    overCost: "高于成本",
    dek: (count: number) =>

...
export const copy = {
  en: {
    ...
    nav: "Net asset value",
    vsCost: "vs cost",
    inspectHint: "Drag the coins. Faces read 1 g, 2 g, 5 g, and 10 g.",
    delayedClose: "Delayed close",
    underCost: "under cost",
    overCost: "over cost",
    dek: (count: number) =>
      `One personal Interactive Brokers account as a delayed close snapshot, counted in 1, 2, 5, and 10 g gold coins at the gold spot on this page. ${count === 1 ? "One name" : `${count} names`}. No live quotes.`,
    cash: "Cash",
    ...
    mark: "mark",
    goldMass: "Gold mass",
    coinRule: (price: string) => `1 / 2 / 5 / 10 g · ${price} / g`,
  ...
  zh: {
    ...
    nav: "净资产",
    vsCost: "相对成本",
    inspectHint: "拖动金币。币面标着 1 克、2 克、5 克、10 克。",
    delayedClose: "延迟收盘",
    underCost: "低于成本",
    overCost: "高于成本",
    dek: (count: number) =>
      `个人盈透证券账户的日终快照，按本页黄金现价用 1、2、5、10 克金币来数。${count} 只标的。非实时行情。`,
    cash: "现金",
    ...
    mark: "现价",
    goldMass: "黄金克重",
    coinRule: (price: string) => `1 / 2 / 5 / 10 克 · ${price} / 克`,
    footer: (statement?: string) =>

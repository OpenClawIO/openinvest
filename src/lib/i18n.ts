...
export const copy = {
  en: {
    ...
    nav: "Net asset value",
    vsCost: "vs cost",
    inspectHint: "A slice is market weight. The line is statement NAV against cost.",
    delayedClose: "Delayed close",
    underCost: "under cost",
    overCost: "over cost",
    dek: (count: number) =>
      `One personal Interactive Brokers account as a delayed close snapshot. Pie is weight. Line is statement NAV versus cost. ${count === 1 ? "One name" : `${count} names`}. No live quotes.`,
    cash: "Cash",
  ...
  zh: {
    ...
    nav: "净资产",
    vsCost: "相对成本",
    inspectHint: "饼图是仓位权重。折线是报表净资产相对成本。",
    delayedClose: "延迟收盘",
    underCost: "低于成本",
    overCost: "高于成本",
    dek: (count: number) =>
      `个人盈透证券账户的日终快照。饼图是仓位，折线是报表净资产相对成本。中文页按本页汇率计人民币。${count} 只标的。非实时行情。`,
    cash: "现金",

...
export const copy = {
  en: {
    ...
    nav: "Net asset value",
    vsCost: "vs cost",
    inspectHint: "Drag the dollars. Notes are modeled $1, $5, $10, $20, $50, and $100.",
    delayedClose: "Delayed close",
    underCost: "under cost",
    overCost: "over cost",
    dek: (count: number) =>
      `One personal Interactive Brokers account as a delayed close snapshot, counted in US dollars. ${count === 1 ? "One name" : `${count} names`}. No live quotes.`,
    cash: "Cash",
    shares: (qty: string) => `${qty} sh`,
    allocation: "Cash on the table",
  ...
  zh: {
    ...
    nav: "净资产",
    vsCost: "相对成本",
    inspectHint: "拖动人民币。纸币按 1、5、10、20、50、100 元建模。",
    delayedClose: "延迟收盘",
    underCost: "低于成本",
    overCost: "高于成本",
    dek: (count: number) =>
      `个人盈透证券账户的日终快照，中文页按本页汇率计人民币。${count} 只标的。非实时行情。`,
    cash: "现金",

...
- Present the book as a 天圆地方 key: a mutton-fat jade bi with a gold square stem, modeled in Blender and shown in Three.js. `prefers-reduced-motion` uses the same silhouette.

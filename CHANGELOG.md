...
- Present the book as a 天圆地方 key: a cabochon mutton-fat jade bi with a gold-lined square hole, round gold stem, and a 回-pattern bit, modeled in Blender and shown in Three.js. `prefers-reduced-motion` uses the same silhouette.
